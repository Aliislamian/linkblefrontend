...
import CompletedOrderInformation from "../CompletedOrderInformation/CompletedOrderInformation.css";
...
import ServiceRequirementDropDown from "../OrderInformation/ServiceRequirementDropDown";
      ...
      >
        <div className="order_info_main">
          ...
          <OrderCard
            ...
            OrderCardNavigation={"/review-as-buyer"}
          />
          ...
          <div
            className="go-to-conservation-contianer"
            onClick={() => {
              navigate("/chat");
            }}
          >
